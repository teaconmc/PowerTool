...
public class MartingCarOverlay {
    ...
    public static void renderBoostBar(GuiGraphicsExtractor guiGraphics, DeltaTracker deltaTracker) {
        ...
        guiGraphics.outline(guiGraphics.guiWidth() / 2 - 100, guiGraphics.guiHeight() - 50, 200, 10, -1);
        ...
        guiGraphics.text(font, "boost", guiGraphics.guiWidth() / 2 - 102 - font.width("boost"), guiGraphics.guiHeight() - 48, -1, true);
    }
}
